  ...
  useEffect(() => {
    setAppData({
      courses: [
        {
          name: 'Biology',
          grades: [95, 92, 80, 91, 95, 85],
          cellKey: '!!!',
          hash: '!!!',
          credit: 1,
          otherFields: [{ key: 'Course Code', value: 'BIOLOGY' }],
          weighted: true,
        },
        {
          name: 'English',
          grades: [80, 95, 100, 90, 70, 90],
          cellKey: '@@@',
          hash: '@@@',
          credit: 1,
        ...
        {
          name: 'Geometry',
          grades: ['P', 'P', '75', 'P', 'P', 98],
          cellKey: '###',
          hash: '###',
          credit: 2,
          otherFields: [{ key: 'Course Code', value: 'GEOMETRY AB' }],
          weighted: true,
        },
        {
          name: 'US History',
          grades: [80, 95, 100, 90, 70, 95],
          cellKey: 'aaa',
          hash: 'aaa',
          credit: 1,
          otherFields: [{ key: 'Course Code', value: 'ADV US HIS' }],
          weighted: true,
        },
        {
          name: 'Make it with Code',
          grades: [80, 95, 100, 90, 70, 'NG'],
          cellKey: 'bbb',
          hash: 'bbb',
          credit: 1,
          otherFields: [{ key: 'Course Code', value: 'ADV ROBOTICS' }],
          weighted: false,
        },
        {
          name: 'Art',
          grades: [80, 95, 100, 90, 70, 94],
          cellKey: 'ccc',
          hash: 'ccc',
          credit: 1,
          otherFields: [{ key: 'Course Code', value: 'STUDIO DRWNG' }],
          weighted: false,
        },
      ],
      gradingPeriods: [
