    ...
    <div className="">
      ...
      <div className="bg-accent-100 dark:bg-accent-800 p-20">
        <div className="p-8 shadow-lg bg-mono-l-100 dark:bg-mono-d-100 dark:text-mono-d-600 font-os text-sm rounded-md">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Scorecard.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Scorecard, accessible from{" "}
                <a
                  href="scorecardgrades.com"
          ...
          <ul>
            <li>By email: help@scorecardgrades.com</li>
          </ul>
        </div>
      </div>{" "}
    </div>
