...
export default function NotificationSummary(props: {
  ...
  return (
    <div className="relative w-fit pt-4 pb-12 px-6 flex">
      <div className="border-mono-l-400 dark:border-mono-d-400 absolute h-full w-full top-0 left-0 border-t border-x rounded-t-lg"></div>
      ...
      <div className="border-mono-l-400 dark:border-mono-d-400 bg-mono-l-100 dark:bg-mono-d-100 absolute h-10 w-full bottom-0 left-0 border-t border-x rounded-t-lg"></div>
      <div className="border-mono-l-400 dark:border-mono-d-400 bg-mono-l-200 dark:bg-mono-d-200 absolute h-5 w-full bottom-0 left-0 border-t border-x rounded-t-lg"></div>
    </div>
  );
}
